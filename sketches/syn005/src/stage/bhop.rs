...
impl Bhop {
    pub fn new(app: &App) -> Self {
        ...
        let scene = resource::read_scene(device, "bhop.glb");
    ...
    fn init(&mut self, app: &App, m: &mut Model, dt: f32) {
        ...
        self.animator.play(m.t, true, "Action.002");
        self.animator.play(m.t, true, "Pillar.002Action");
        self.animator.play(m.t, true, "Pillar.003Action");
    }
